...
class BSTNode {
	...
	BSTNode(double key, bool verbose=true) : key(key), verbose(verbose) {
		left = nullptr;
		right = nullptr;
		parent = nullptr;
	}
...
int main(){
    //Punto a
    int n;
    cout << "Inserire il numero di elementi: " << endl;
    cin >> n;
    Shape* array[n];
    int i=0;
    int num;
    do{
        ...
        if(num == 1){
            ...
            cin >> base;
            cin >> altezza;
            array[i]=new Rectangle(altezza , base);
        }
        if(num == 2){
            double raggio;
            cin >> raggio;
            array[i]=new Circle(raggio);
        }
        if(num == 3){
            int base, altezza;
            cin >> base;
            cin >> altezza;
            array[i]=new Triangle(altezza, base);
        }
        i++;
    }while(i<n);
